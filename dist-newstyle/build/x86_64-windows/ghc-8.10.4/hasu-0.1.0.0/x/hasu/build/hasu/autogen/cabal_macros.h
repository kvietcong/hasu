...
/* package hasu-0.1.0.0 */
#ifndef VERSION_hasu
#define VERSION_hasu "0.1.0.0"
#endif /* VERSION_hasu */
#ifndef MIN_VERSION_hasu
#define MIN_VERSION_hasu(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hasu */
...
#define CURRENT_COMPONENT_ID "hasu-0.1.0.0-inplace-hasu"
